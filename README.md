...
In Visual Studio Code, open the local folder containing this repository. Open any of the .py files and locate the debug/run options in the top right of VSCode. Run or debug, and you should see output populate in the VSCode terminal.
